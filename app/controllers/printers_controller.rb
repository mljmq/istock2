class PrintersController < ApplicationController
  ...
  def new
    @printer = Printer.new
    @printer.creator_id = current_user.email
    @printer.updater_id = current_user.email
  end
  ...
  def create
    ...
    respond_to do |format|
      if @printer.save
        format.html { redirect_to printers_url, notice: 'Printer was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @printer.update(printer_params)
        format.html { redirect_to printers_url, notice: 'Printer was successfully updated.' }
  ...
  private
    ...
    def printer_params
      params.require(:printer).permit(:uuid, :code, :name, :ip, :port, :creator_id, :updater_id)
    end
end
